...
#4. Use geom_jitter with stat_smooth to examine the association between dew point temperature and wind speed by region: Colour points by region, Make sure to deal with NA category, Fit a linear regression line by region, Describe what you observe in the graph
```{r, scatterplot, dew point}
met_avg[!is.na(region) & !is.na(wind.sp)] %>% 
